...
describe ProjectPolicy do
  ...
  context "policy_scope" do 
    ...
    it "includes projecs a user is allowed to view" do 
      assign_role!(user, :viewer, project) 
      expect(subject).to include(project)
    end 

    it "doesn't include project a user is not allowed to view" do 
      expect(subject).to be_empty 
    end 

    it "returns all project for admins" do 
     user.admin = true 
     expect(subject).to include(project)
    end
  end
  ...
  permissions :show? do
    ...
    it "allows viewerers of the project" do 
      assign_role!(user, :viewer, project)
    ...
    it "doesn't allow user assigned to other projects" do 
